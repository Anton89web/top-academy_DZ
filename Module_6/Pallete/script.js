...
function AddPallet () {
    ...
    function innerDiv (arr) {
        ...
        arr.forEach((element => {
            let div = `<div style='background-color:${element.createStrColor()}' class='newdiv'><p>${element.name}</p><p>${element.type}</p><p>${element.code}</p></div>`;
